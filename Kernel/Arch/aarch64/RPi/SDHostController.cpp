    ...
    : ::SDHostController()
{
    ...
    m_registers = Memory::map_typed_writable<SD::HostControlRegisterMap volatile>(PhysicalAddress { 0x1'000ff'f000 }).release_value_but_fixme_should_propagate_errors();
}
