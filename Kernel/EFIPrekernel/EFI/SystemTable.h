...
#include <Kernel/EFIPrekernel/EFI/Protocols/ConsoleSupport.h>
#include <Kernel/EFIPrekernel/EFI/Services/BootServices.h>
...
static_assert(__builtin_offsetof(SystemTable, con_out) == 64);
