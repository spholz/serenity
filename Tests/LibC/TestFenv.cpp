...
NEVER_INLINE float black_box(float value)
{
    return value;
}
...
TEST_CASE(float_round_up)
{
    ...
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.2f), 0.3f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.3f), 0.4f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.4f), 0.5f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(-1.f) + black_box(-0.1f), -1.099999f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(1.f) + black_box(0.1f), 1.1f, acceptable_float_error);
}

TEST_CASE(float_round_down)
{
    fesetround(FE_DOWNWARD);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.2f), 0.299999f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.3f), 0.4f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.4f), 0.5f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(-1.f) + black_box(-0.1f), -1.1f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(1.f) + black_box(0.1f), 1.099999f, acceptable_float_error);
...
TEST_CASE(float_round_to_nearest)
{
    ...
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.2f), 0.3, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.3f), 0.4, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(0.1f) + black_box(0.4f), 0.5, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(-1.f) + black_box(-0.1f), -1.1f, acceptable_float_error);
    EXPECT_APPROXIMATE_WITH_ERROR(black_box(1.f) + black_box(0.1f), 1.1f, acceptable_float_error);
}
