...
// NOTE: Item data can be shorter than the *ItemData struct size. In that case the missing fields are 0.
//       This is why all fields are initialized to 0 in those structs.
...
struct [[gnu::packed]] CollectionItemData {
    CollectionType type;
};
static_assert(AssertSize<CollectionItemData, 1>());
