...
static ControlList generate_shader_state_record(Job& job, size_t target_buffer_width, size_t target_buffer_height)
{
    ...
    auto vertex_data_buffer_object = create_buffer_object(align_up_to(vertex_data_size_in_bytes, PAGE_SIZE));
    ...
    auto shaders_buffer_object = create_buffer_object(align_up_to(shaders_blob_size_in_bytes, PAGE_SIZE));
